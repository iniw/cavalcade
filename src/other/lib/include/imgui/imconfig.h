...
// Requires 'stb_sprintf.h' to be available in the include path. Compatibility checks of arguments and formats done by clang and GCC will be disabled
// in order to support the extra formats provided by STB sprintf. #define IMGUI_USE_STB_SPRINTF
...
#define IM_VEC2_CLASS_EXTRA                                                                                                                          \
	ImVec2( const render::point& f ) {                                                                                                               \
		x = f.x;                                                                                                                                     \
		y = f.y;                                                                                                                                     \
	}                                                                                                                                                \
	ImVec2( const render::size& f ) {                                                                                                                \
		x = f.w;                                                                                                                                     \
		y = f.h;                                                                                                                                     \
	}                                                                                                                                                \
	operator render::point( ) const {                                                                                                                \
		return render::point( x, y );                                                                                                                \
	}                                                                                                                                                \
	operator render::size( ) const {                                                                                                                 \
		return render::size( x, y );                                                                                                                 \
	}

#define IM_VEC4_CLASS_EXTRA                                                                                                                          \
	ImVec4( const render::rect& f ) {                                                                                                                \
		x = f.x;                                                                                                                                     \
		y = f.y;                                                                                                                                     \
		z = f.w;                                                                                                                                     \
		w = f.h;                                                                                                                                     \
	}                                                                                                                                                \
	operator render::rect( ) const {                                                                                                                 \
		return render::rect( x, y, z, w );                                                                                                           \
	}
