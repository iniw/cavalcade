...
enum ImGuiFreeTypeBuilderFlags
{
	...
	ImGuiFreeTypeBuilderFlags_LightHinting = 1 << 3, // A lighter hinting algorithm for gray-level modes. Many generated glyphs are fuzzier but better
	                                                 // resemble their original shape. This is achieved by snapping glyphs to the pixel grid only
	                                                 // vertically (Y-axis), as is done by Microsoft's ClearType and Adobe's proprietary font
	                                                 // renderer. This preserves inter-glyph spacing in horizontal text.
